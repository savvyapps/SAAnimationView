...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://savvyapps.com"
  ...
  # Or just: s.author    = "Emilio Peláez"
  # s.authors            = { "Emilio Peláez" => "emilio.pelaez@savvyapps.com" }
  # s.social_media_url   = "http://twitter.com/SavvyApps"
